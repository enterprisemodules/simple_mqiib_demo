...
puppet_installer   = 'puppet-enterprise-2017.2.1-el-7-x86_64/puppet-enterprise-installer'
...
EOD
      ...
      when 'pe-master'
        ...
        srv.vm.provision :shell, inline: "/vagrant/software/#{puppet_installer} -c /vagrant/pe.conf -y"
        #
